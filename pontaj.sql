...
CREATE TABLE `assignments` (
  ...
  CONSTRAINT `projects_projectId_fk` FOREIGN KEY (`projectId`) REFERENCES `projects` (`projectId`),
...
INSERT INTO `assignments` VALUES (1,4,1),(2,4,2),(3,1,2),(4,2,1);
...
CREATE TABLE `timetables` (
  ...
  CONSTRAINT `assignments_assignmentId_fk` FOREIGN KEY (`assignmentId`) REFERENCES `assignments` (`assignmentId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `timetables` VALUES (1,4,'2017-08-10','08:00:00'),(2,2,'2017-08-19','06:00:00'),(3,3,'2017-08-21','08:00:00');
...
-- Dump completed on 2017-08-23 12:34:53
